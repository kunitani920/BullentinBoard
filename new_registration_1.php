...
<div class="container">
  ...
  <h4 class="mt-3"><?php echo var_dump($error_msg); ?></h4>
    ...
    <div class="form-row mt-5">
      ...
      <div class="form-row">
        <div class="form-group col-md-4">
          ...
          <input type="text" class="form-control" id="inputNickname" name="NickName" placeholder="ヤマちゃん" value="<?php if(isset($clean['LastName'])){echo $clean['LastName'];}?>">
        </div>
        <div class="col-md-8">
          <!-- 空白 -->
        </div>
