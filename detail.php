...
<body style="padding-top:4.5rem;">
    ...
    <div class="container"> 
        ...
        <div class="row justify-content-center mt-5">    
            <div class="col-sm-12 col-lg-4">
                <div class="row justify-content-center">
                    <img class="img-fluid rounded-circle bd-placeholder-img" width="40%" height="auto" src="./img/<?php echo $member_info['icon']; ?>" alt="未登録" </img>
                </div>
                <div class="row justify-content-center">
                    <?php
                        for($i = 1; $i <= 3; $i++) {
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-12 col-lg-5 card border-info m-2">
                <div class="card-body text-info">
                    <p class="card-text">氏名：<?php echo $member_info['last_name'] . ' ' . $member_info['first_name']; ?></p>
                </div>
            </div>
            <div class="col-sm-12 col-lg-5 card border-info m-2">
                <div class="card-body text-info">
